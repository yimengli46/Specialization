'''
explore a scene through frontier exploration and save the poses and actions.
'''
...
occ_map_npy = np.load(f'{cfg.SAVE.OCCUPANCY_MAP_PATH}/{split}/{scene_name}/BEV_occupancy_map.npy',
