...
from habitat_web_baselines.config.default import get_config as cfg_baseline
from habitat_web_baselines.slambased.mappers import DirectDepthMapper
from habitat_web_baselines.slambased.monodepth import MonoDepthEstimator
from habitat_web_baselines.slambased.path_planners import DifferentiableStarPlanner
from habitat_web_baselines.slambased.reprojection import (
...
from habitat_web_baselines.slambased.utils import generate_2dgrid
...
class ORBSLAM2MonodepthAgent(ORBSLAM2Agent):
    def __init__(
        ...
        monocheckpoint="habitat_web_baselines/slambased/data/mp3d_resnet50.pth",
    ):
