...
class BaselineRegistry(Registry):
    ...
    def register_trainer(cls, to_register=None, *, name: Optional[str] = None):
        ...
        """
        from habitat_web_baselines.common.base_trainer import BaseTrainer
    ...
    def register_policy(cls, to_register=None, *, name: Optional[str] = None):
        ...
        .. code:: py
            ...
            from habitat_web_baselines.rl.ppo.policy import Policy
            from habitat_web_baselines.common.baseline_registry import (
                baseline_registry
            )
    ...
    def register_obs_transformer(
        ...
        .. code:: py
            ...
            from habitat_web_baselines.common.obs_transformers import ObservationTransformer
            from habitat_web_baselines.common.baseline_registry import (
                baseline_registry
            )
